...
class StockholmIterator(AlignmentIterator):
    """Loads a Stockholm file from PFAM into MultiSeqAlignment objects.
    ...
    def next(self):
        ...
        if ids and seqs:
            ...
            for id in ids:
                ...
                #Annotations will be overridden by _populate_meta_data if an
                #explicit accession is provided:
                record = SeqRecord(Seq(seq, self.alphabet), id=id,
