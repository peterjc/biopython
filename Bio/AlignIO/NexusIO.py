...
def NexusIterator(handle, seq_count=None) :
    ...
    meaning this iterator will only yield one MultiSeqAlignment."""
    ...
    for old_name, new_name in zip (n.unaltered_taxlabels, n.taxlabels) :
        ...
        alignment.append(SeqRecord(seq,
                                   id=new_name,
                                   name=old_name,
                                   description=""))
    #All done
...
class NexusWriter(AlignmentWriter) :
    ...
    def write_file(self, alignments) :
        ...
        alignments - A list or iterator returning MultiSeqAlignment or
                     the older Alignment objects.
