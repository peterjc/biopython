    ...
    try:
        ...
        while filenames:
            ...
            args = ["--no-diffs",
                    ...
                    #"--fix=basestring", -- handled via six.string_types
                    ...
                    #"--fix=itertools", -- not needed anymore
                    #"--fix=itertools_imports", -- not needed anymore
                    #"--fix=long",
                    ...
                    #"--fix=xrange", -- handled via six.moves.range
