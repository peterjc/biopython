...
class GenBankLocations(unittest.TestCase):
    ...
    def check_loc(self, expected_location_obj, input_location_str):
    ...
    def test_rev_comp_styles(self):
        ...
        self.check_loc(expected_loc, embl_str)
        # TODO self.assertEqual(ncbi_str, _insdc_feature_location_string(loc, ...))
