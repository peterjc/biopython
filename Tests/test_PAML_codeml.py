...
class ModTest(unittest.TestCase):
    ...
    def testAlignmentFileIsValid(self):
        self.assertRaises(
            (AttributeError, TypeError, OSError), codeml.Codeml, alignment=list()
        )
    ...
    def testTreeFileValid(self):
        self.assertRaises(
            (AttributeError, TypeError, OSError), codeml.Codeml, tree=list()
        )
    ...
    def testCtlFileValidOnRun(self):
        ...
        self.cml.out_file = self.out_file
        self.assertRaises(
            (AttributeError, TypeError, OSError), self.cml.run, ctl_file=list()
        )
    ...
    def testCtlFileValidOnRead(self):
        self.assertRaises(
            (AttributeError, TypeError, OSError), self.cml.read_ctl_file, list()
        )
        self.assertRaises(
    ...
    def testResultsValid(self):
        self.assertRaises((AttributeError, TypeError, OSError), codeml.read, list())
