...
class TestMedline(unittest.TestCase):
    ...
    def test_parse(self):
        ...
        self.assertEqual(
            record["FAU"], ["Casbon, James A", "Crooks, Gavin E", "Saqi, Mansoor A S"]
        )
        ...
        self.assertEqual(record["PST"], "ppublish")
        self.assertEqual(
            record["SO"], "Bioinformatics. 2006 Mar 1;22(5):616-7. Epub 2005 Dec 23."
        )
        record = next(records)
        ...
        self.assertEqual(record["PST"], "ppublish")
        self.assertEqual(
            record["SO"], "Bioinformatics. 2004 Jun 12;20(9):1453-4. Epub 2004 Feb 10."
        )
        record = next(records)
        ...
        self.assertEqual(
            record["TI"], "PDB file parser and structure class implemented in Python."
        )
