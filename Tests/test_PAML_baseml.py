...
class ModTest(unittest.TestCase):
    ...
    def testAlignmentFileIsValid(self):
        self.assertRaises(
            (AttributeError, TypeError, OSError), baseml.Baseml, alignment=list()
        )
    ...
    def testTreeFileValid(self):
        self.assertRaises(
            (AttributeError, TypeError, OSError), baseml.Baseml, tree=list()
        )
    ...
    def testCtlFileValidOnRun(self):
        ...
        self.bml.out_file = self.out_file
        self.assertRaises(
            (AttributeError, TypeError, OSError), self.bml.run, ctl_file=list()
        )
    ...
    def testCtlFileValidOnRead(self):
        self.assertRaises(
            (AttributeError, TypeError, OSError), self.bml.read_ctl_file, list()
        )
        self.assertRaises(
    ...
    def testResultsValid(self):
        self.assertRaises((AttributeError, TypeError, OSError), baseml.read, list())
