...
class IndexDictTests(SeqIOTestBaseClass):
    ...
    tests = [
        ("Ace/contig1.ace", "ace", Alphabets.DNA),
        ("Ace/consed_sample.ace", "ace", None),
        ("Ace/seq.cap.ace", "ace", Alphabets.DNA),
        ...
        ("Quality/zero_length.fastq", "fastq", Alphabets.DNA),
        ...
        ("EMBL/patents.embl", "embl", Alphabets.Protein),
        ("EMBL/AAA03323.embl", "embl", None),
        ("GenBank/NC_000932.faa", "fasta", Alphabets.Protein),
        ("GenBank/NC_005816.faa", "fasta", Alphabets.Protein),
        ("GenBank/NC_005816.tsv", "tab", Alphabets.Protein),
        ("GenBank/NC_005816.ffn", "fasta", Alphabets.DNA),
        ("GenBank/NC_005816.fna", "fasta", Alphabets.DNA),
        ...
        ("IntelliGenetics/vpu_nucaligned.txt", "ig", Alphabets.Nucleotide),
        ("IntelliGenetics/TAT_mase_nuc.txt", "ig", None),
        ("IntelliGenetics/VIF_mase-pro.txt", "ig", Alphabets.Protein),
        ("Phd/phd1", "phd", Alphabets.DNA),
        ("Phd/phd2", "phd", None),
        ("Phd/phd_solexa", "phd", Alphabets.DNA),
        ("Phd/phd_454", "phd", Alphabets.DNA),
        ("NBRF/B_nuc.pir", "pir", Alphabets.Nucleotide),
        ("NBRF/Cw_prot.pir", "pir", Alphabets.Protein),
        ...
        ("Roche/E3MFGYR02_random_10_reads.sff", "sff", Alphabets.DNA),
        ("Roche/E3MFGYR02_random_10_reads.sff", "sff-trim", Alphabets.DNA),
        ("Roche/E3MFGYR02_index_at_start.sff", "sff", Alphabets.DNA),
        ("Roche/E3MFGYR02_index_in_middle.sff", "sff", Alphabets.DNA),
        ("Roche/E3MFGYR02_alt_index_at_start.sff", "sff", Alphabets.DNA),
        ("Roche/E3MFGYR02_alt_index_in_middle.sff", "sff", Alphabets.DNA),
        ("Roche/E3MFGYR02_alt_index_at_end.sff", "sff", Alphabets.DNA),
        ("Roche/E3MFGYR02_no_manifest.sff", "sff", Alphabets.DNA),
        ("Roche/greek.sff", "sff", Alphabets.Nucleotide),
        ("Roche/greek.sff", "sff-trim", Alphabets.Nucleotide),
